---
name: theming
description: Build a centralized Material 3 theme with ColorScheme, TextTheme, and ThemeExtensions; use when defining colors, typography, dark mode, or design tokens.
---

---
name: test
description: Write Flutter unit, widget, golden, and integration tests with coverage; use when testing logic, widgets, state management, or wiring tests into CI.
---
